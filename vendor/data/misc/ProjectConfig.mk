...
CUSTOM_HAL_IMGSENSOR = ov8865_mipi_raw imx214_mipi_raw imx214otp_mipi_raw ov5670_mipi_raw  
CUSTOM_HAL_LENS = dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = ov8865_mipi_raw imx214_mipi_raw imx214otp_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = ov8865_mipi_raw imx214_mipi_raw imx214otp_mipi_raw ov5670_mipi_raw 
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov8865_mipi_raw imx214_mipi_raw imx214otp_mipi_raw
...
CUSTOM_MODEM = p2q-LWTG_R2_6763-3M-G4W12458F12345781217192028_hotswap
...
#prize-oversea remove cta feature-YZHD-20190104-begin
MTK_CTA_SET = no
#prize-oversea remove cta feature-YZHD-20190104-end
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#prize-oversea remove privacy protection lock feature-YZHD-20190104-begin
MTK_PRIVACY_PROTECTION_LOCK = no
#prize-oversea remove privacy protection lock feature-YZHD-20190104-end
...
PRIZE_FLASH_SIZE = prize_32g3g_flash
PRIZE_SW_VERSION= P2QV23A.GQU.EEA.GHdianchi.HB.HJ.$(PRIZE_FLASH_CODE).$(shell date +%m%d).V3.02

MTK_CW2015_SUPPORT = no
PRIZE_FINGER_PRINT = no
#---------------------------工厂测试----------------------------------
#校准结果信息是否使用0.1来表示，yes：使用0.1表示，no：使用 未校准/已校准
...
PRIZE_FUNCTION_KEY    =POWER_HOME_BACK
#工厂测试是否显示语言却换按钮
...
PRIZE_TEE=2
#桌面与8802状态中是否打开TEE免加密狗，yes为打开免TEE加密狗，TEE与人脸激活状态不显示
